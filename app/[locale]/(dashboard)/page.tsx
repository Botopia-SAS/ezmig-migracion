...
export default function HomePage() {
  ...
  return (
    <main className="overflow-hidden bg-white dark:bg-[#0B0B0F]">
      ...
      <section className="w-full">
        <MacbookScroll
            ...
            cta={
              ...
              >
                <button className="h-full w-full cursor-pointer rounded-full bg-gradient-to-r from-neutral-100 via-neutral-100 to-white px-8 py-4 text-lg sm:text-base sm:px-6 sm:py-3 text-black shadow-[0px_2px_0px_0px_var(--color-neutral-50)_inset,0px_0.5px_1px_0px_var(--color-neutral-400)] transition-all duration-100 active:scale-95 dark:from-black dark:via-black dark:to-neutral-900 dark:text-white dark:shadow-[0px_1px_0px_0px_var(--color-neutral-950)_inset,0px_1px_0px_0px_var(--color-neutral-800)] font-medium">
                  {t('hero.cta')} &rarr;
                </button>
              </NoiseBackground>
            }
      ...
      {/* Features Carousel */}
      <section id="features" className="w-full -mt-32 sm:-mt-20 md:mt-0 pt-0 sm:pt-20 md:pt-96 pb-10">
